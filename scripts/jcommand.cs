...
{
public class jcommand : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        sliderVals[0] = GUI.HorizontalSlider(new Rect(25, slider_y, 100, slider_height), sliderVals[0], 0F, 1F);
        // foreach (int idx in Range(0,sliderVals.Count)) {
