...
{
    public class QuaternionState : Message
    {
        public const string RosMessageName = "robotics_demo/QuaternionState";
        ...
        public QuaternionState(float pos_x, float pos_y, float pos_z, float q1, float q2, float q3, float q4, float gripper)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
